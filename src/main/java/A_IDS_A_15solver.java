 ...
 * @param heuristic
 */
	public ArrayList<Nodes> A_Star(Nodes startState, String heuristic){
		...
		Nodes solution = start_A_Star.findSolutionPath();	//returns the node that contains the solved puzzle
		...
		{
			ArrayList<Nodes> solutionPath = start_A_Star.getSolutionPath(solution);	//creates ArrayList of solution path
	...
	public void printSolution(ArrayList<Nodes> path){
	...
	public void printState(Nodes node){
